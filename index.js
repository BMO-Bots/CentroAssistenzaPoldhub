...
const url = `https://twitch.tv/poldo`;
client.on('ready', () => {
  client.user.setActivity(`Godopoli: ${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} abitanti`, { type: 'STREAMING', url: url }) //you can replace "#"
